  ...
  class SoundCloud < Liquid::Tag
    ...
    def render(context)
      if @type and @type != :error and @id
        ...
        "<iframe id=\"sc-widget\" width=\"100%\" height=\"#{@height}\" scrolling=\"no\" frameborder=\"no\" src=\"http://w.soundcloud.com/player/?url=http%3A%2F%2Fapi.soundcloud.com%2F#{@resource}%2F#{@id}#{@extra}&amp;#{@joined_options}\"></iframe>"
      elsif @type == :error
